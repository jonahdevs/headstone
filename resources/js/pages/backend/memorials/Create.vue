...
const breadcrumbs = [
    ...
    { title: 'Create Memorial', href: '/admin/memorials/create' },
];
        ...
        <section class="@container">
            <div class="flex flex-col flex-wrap items-start gap-6 @2xl:flex-row">
                <div class="w-full max-w-sm rounded-xl border p-5">
                    ...
                    <div class="mt-4 space-y-6">
                        <div v-if="mainImage()">
                            ...
                            <div class="flex items-center gap-3">
                                <p class="text-xs text-slate-600 dark:bg-slate-400">{{ mainImage()?.path }}</p>
                        ...
                        <div v-if="galleryImages().length > 0">
                            ...
                            <div class="mt-1 flex flex-col gap-2">
                                <template v-for="image in galleryImages()" :key="image.id">
                                    <div class="flex items-center gap-3">
                                        <p class="text-xs text-slate-600 dark:bg-slate-400">{{ image.path }}</p>
                    ...
                    <div v-for="([key, error], index) in Object.entries(form.errors).filter(([k]) => k.startsWith('gallery_images.'))" :key="key">
                            ...
                            <div class="mt-2 flex w-full justify-center rounded-lg border border-dashed px-6 py-10">
                                <div class="text-center">
                                    ...
                                    <div class="text-muted-foreground mt-4 flex text-sm/6">
                                        <label
                                            for="file-upload"
                                            class="relative cursor-pointer rounded-md font-semibold text-indigo-600 focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 focus-within:outline-hidden hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300"
                                        >
