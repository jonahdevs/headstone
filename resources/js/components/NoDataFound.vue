    ...
    <div class="h-24 w-24">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 40" x="0px" y="0px" fill="currentColor">
            <g data-name="No Data Found, Not Found, Lost, Searching, Search">
                ...
                <path d="M25.5,5A2.5,2.5,0,1,0,28,7.5,2.5,2.5,0,0,0,25.5,5Zm0,4A1.5,1.5,0,1,1,27,7.5,1.5,1.5,0,0,1,25.5,9Z" />
                <path d="M9,6A2,2,0,1,0,7,8,2,2,0,0,0,9,6ZM6,6A1,1,0,1,1,7,7,1,1,0,0,1,6,6Z" />
                <path d="M8.5,26H8v-.5a.5.5,0,0,0-1,0V26H6.5a.5.5,0,0,0,0,1H7v.5a.5.5,0,0,0,1,0V27h.5a.5.5,0,0,0,0-1Z" />
            </g>
        </svg>
    </div>

    <p class="mt-1 font-semibold">No Data Found</p>
</template>
